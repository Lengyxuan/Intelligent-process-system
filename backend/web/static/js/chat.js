...
const I18N = {
    zh: {
        globalSearch: ["工艺知识库", "全局检索与块管理"],
        sessionSearch: ["方案记录", "当前工作记录管理"],
        collapseOpen: ["收起侧栏", "保留主工作区"],
        collapseClosed: ["展开侧栏", "显示记录与设置"],
        commonSettings: ["系统设置", "API 与健康检测"],
        paramSettings: ["检索参数", "RAG、知识库、生成参数"],
        themeChat: "工作台",
        themeResearch: "精简视图",
        currentSession: "当前方案编号：",
        date: "日期：",
        apiStatus: "API状态",
        llm: "LLM：",
        arpmStatus: "检索底座状态：",
        ...
        export: "导出当前方案",
        welcomeTitle: "智匠系统",
        welcomeText: "基于 RAG 的智能工艺规划与知识检索工作台",
        configure: "配置 API",
        params: "查看检索参数",
        inputPlaceholder: "请输入工艺需求，例如：请为小批量铝合金薄壁件生成数控铣削工艺路线，要求高精度，设备为三轴数控铣床。",
        send: "生成工艺方案",
        ready: "就绪",
        stats: (knowledge, sessions, vectors) => `知识块 ${knowledge} · 方案记录 ${sessions} · 向量 ${vectors}`,
        clearContext: "清空当前方案",
        clearContextIndex: "清空当前方案和索引",
        ragPanel: "工艺知识检索结果",
        cotPanel: "方案评估与审核记录",
        settingsTitle: "系统设置",
        paramsTitle: "检索与生成参数",
        ...
        userTitle: "工程师信息",
        userName: "工程师名称",
        userPersona: "工艺背景说明（可选）",
        aiTitle: "方案生成默认设定",
        characterName: "生成助手名称",
        systemPrompt: "生成指令",
        basicTitle: "基础检测",
    ...
    en: {
        globalSearch: ["Process Knowledge", "Global search and chunks"],
        sessionSearch: ["Plan Records", "Current workspace records"],
        collapseOpen: ["Collapse", "Keep the workspace focused"],
        collapseClosed: ["Expand", "Show sessions and settings"],
        commonSettings: ["System", "API and health checks"],
        paramSettings: ["Parameters", "Retrieval, knowledge, experiments"],
        themeChat: "Workbench",
        themeResearch: "Compact",
        currentSession: "Plan:",
        date: "Date:",
        apiStatus: "API",
        llm: "LLM:",
        arpmStatus: "Retrieval base",
        ...
        arpmError: "Issue",
        export: "Export plan",
        welcomeTitle: "Zhijiang System",
        welcomeText: "RAG-powered intelligent process planning and knowledge retrieval workbench.",
        configure: "Configure API",
        params: "Review retrieval parameters",
        inputPlaceholder: "Enter a process requirement, for example: generate a CNC milling route for a small-batch high-precision aluminum thin-wall part on a 3-axis CNC mill.",
        send: "Generate Process Plan",
        ready: "Ready",
        stats: (knowledge, sessions, vectors) => `Knowledge ${knowledge} · Plans ${sessions} · Vectors ${vectors}`,
        clearContext: "Clear current plan",
        clearContextIndex: "Clear current plan and index",
        ragPanel: "Process knowledge retrieval",
        cotPanel: "Plan evaluation and review",
        settingsTitle: "System settings",
        paramsTitle: "Retrieval and generation parameters",
        apiConfigTitle: "API configuration",
        apiKey: "API key",
        baseUrl: "Base URL",
        modelName: "Model",
        userTitle: "Engineer profile",
        userName: "Engineer name",
        userPersona: "Process background (optional)",
        aiTitle: "Generation defaults",
        characterName: "Assistant name",
        systemPrompt: "Generation instruction",
        ...
        ablationTitle: "RAG retrieval switches",
        tuningTitle: "Retrieval and generation tuning",
        presets: "Presets",
        ...
        refresh: "Refresh",
        apiTest: "Test API",
        arpmReport: "Retrieval base report",
        loadKbChunks: "Load knowledge chunks",
        loadChatChunks: "Load plan records",
...
const State = {
    ...
    sessionConfig: {
        user_name: "\u5de5\u827a\u5de5\u7a0b\u5e08",
        user_persona: "",
        character_name: "\u5de5\u827a\u65b9\u6848\u52a9\u624b",
        system_prompt: "\u4f60\u662f\u667a\u5320\u7cfb\u7edf\u7684\u5de5\u827a\u89c4\u5212\u52a9\u624b\uff0c\u57fa\u4e8e\u68c0\u7d22\u5230\u7684\u5de5\u827a\u77e5\u8bc6\u548c\u7528\u6237\u9700\u6c42\uff0c\u751f\u6210\u7ed3\u6784\u6e05\u6670\u3001\u53ef\u5ba1\u6838\u7684\u5de5\u827a\u65b9\u6848\u3002"
    },
    protocolConfig: {
        protocol_mode: "auto",
...
function setupSettingsPanels() {
    ...
    DOM.sectionAiTitle?.closest(".config-section")?.classList.add("hidden");
    DOM.labelUserPersona?.closest(".form-item")?.classList.add("hidden");
...
function renderLanguage() {
    ...
    DOM.btnSend && (DOM.btnSend.textContent = text.send);
    ...
    const title = State.language === "en" ? "Zhijiang System" : "智匠系统";
    document.title = State.language === "en"
        ? "Zhijiang System - RAG Process Planning Workbench"
        : "智匠系统 - 基于 RAG 的智能工艺规划与知识检索工作台";
    document.querySelector(".brand-logo") && (document.querySelector(".brand-logo").textContent = title);
    document.querySelector("#kb-modal .modal-header h2") && (document.querySelector("#kb-modal .modal-header h2").textContent = State.language === "en" ? "Knowledge Base Management" : "工艺知识库管理");
    document.querySelector("#diagnose-modal .modal-header h2") && (document.querySelector("#diagnose-modal .modal-header h2").textContent = State.language === "en" ? "System Diagnostics" : "系统自检");
    document.querySelector("#arpm-report-section h3") && (document.querySelector("#arpm-report-section h3").textContent = State.language === "en" ? "Retrieval Base Report" : "检索底座报告");
    document.querySelector("#rag-help-modal .modal-header h2") && (document.querySelector("#rag-help-modal .modal-header h2").textContent = State.language === "en" ? "RAG Retrieval Flow" : "RAG 检索逻辑说明");
...
function renderWorkbenchOverview() {
    ...
    let overview = document.getElementById("workbench-overview");
    if (!overview) {
        overview = document.createElement("div");
        overview.id = "workbench-overview";
        overview.className = "workbench-overview";
        const actions = DOM.welcome.querySelector(".welcome-actions");
        DOM.welcome.insertBefore(overview, actions || null);
    }
    const isEnglish = State.language === "en";
    const areas = isEnglish
        ? [
            ["Process requirement input", "Capture part, batch, material, precision, equipment, and constraints."],
            ["Process knowledge retrieval", "Show RAG hits from the knowledge base and existing indexed records."],
            ["Process plan generation", "Generate a reviewable process route through the existing LLM chain."],
            ["Plan evaluation", "Reserve quality, feasibility, and risk review space for later PRs."],
            ["Expert review", "Reserve manual confirmation and knowledge feedback workflow."]
        ]
        : [
            ["工艺需求输入区", "录入零件、批量、材料、精度、设备与约束条件。"],
            ["工艺知识检索结果区", "展示知识库与既有索引记录的 RAG 召回结果。"],
            ["工艺方案生成区", "复用现有 LLM 生成链路输出可审核的工艺路线。"],
            ["方案评估区", "预留质量、可行性与风险评估展示位。"],
            ["专家审核区", "预留人工确认与知识库反哺工作流。"]
        ];
    overview.innerHTML = areas.map(([title, desc], index) => `
        <section class="workbench-card">
            <span class="workbench-step">${String(index + 1).padStart(2, "0")}</span>
...
function syncStateToForm() {
    ...
    DOM.cfgUserName.value = State.sessionConfig.user_name || "\u5de5\u827a\u5de5\u7a0b\u5e08";
    DOM.cfgUserPersona.value = State.sessionConfig.user_persona || "";
    DOM.cfgCharacterName.value = State.sessionConfig.character_name || "\u5de5\u827a\u65b9\u6848\u52a9\u624b";
...
function syncFormToState() {
    ...
    State.sessionConfig = {
        user_name: DOM.cfgUserName.value.trim() || "\u5de5\u827a\u5de5\u7a0b\u5e08",
        user_persona: DOM.cfgUserPersona.value.trim(),
        character_name: DOM.cfgCharacterName.value.trim() || "\u5de5\u827a\u65b9\u6848\u52a9\u624b",
...
function createMessageElement(message) {
    ...
    const roleName = message.role === "assistant"
        ? "\u5de5\u827a\u65b9\u6848"
        : "\u5de5\u827a\u9700\u6c42";
    const avatar = message.role === "assistant" ? "\u65b9\u6848" : "\u9700\u6c42";
...
function renderSessions(items) {
    ...
    if (!items.length) {
        DOM.sessionList.innerHTML = '<div class="empty" style="padding:16px;color:var(--text-tertiary);">\u6682\u65e0\u65b9\u6848\u8bb0\u5f55</div>';
        return;
    }
    ...
    for (const item of items) {
        ...
        button.innerHTML = `
            ...
            <span style="font-size:12px;color:var(--text-tertiary);">\u5de5\u827a\u65b9\u6848</span>
        `;
...
function renderRagContext(context) {
    ...
    for (const block of chatBlocks) {
        items.push(`
            <div class="rag-item">
                <div class="rag-header">
                    <span class="rag-source">\u5f53\u524d\u65b9\u6848\u8bb0\u5f55 \u00b7 ${Utils.escapeHtml(block.user_name || "\u5de5\u827a\u5de5\u7a0b\u5e08")}</span>
                    <span class="rag-score">\u8bed\u4e49 ${block.semantic_score ?? "-"}</span>
                </div>
                <div class="rag-text">${Utils.formatText(block.text || "")}</div>
                <div class="rag-meta">\u8f6e\u6b21 ${block.round_num ?? "-"} \u00b7 \u65f6\u95f4 ${Utils.escapeHtml(block.physical_time || "-")} \u00b7 \u6743\u91cd ${block.temporal_weight ?? "-"}</div>
...
function exportCurrentSession() {
    ...
    const lines = [
        `\u667a\u5320\u7cfb\u7edf\u5f53\u524d\u5de5\u827a\u65b9\u6848\u5bfc\u51fa`,
        `\u65b9\u6848\u7f16\u53f7: ${State.sessionName || State.sessionId || "-"}`,
    ...
    link.download = `${State.sessionName || State.sessionId || "zhijiang-process-plan"}.txt`;
...
function renderArpmReport(report) {
    ...
    const currentRuntime = `
        <div class="chunk-item">
            <div class="chunk-header">
                <strong>\u5f53\u524d\u65b9\u6848\u751f\u6210\u53c2\u6570</strong>
                <span class="chunk-source">runtime</span>
            </div>
            <div class="chunk-text">\u8fd9\u91cc\u5c55\u793a\u5f53\u524d\u524d\u7aef\u63d0\u4ea4\u7ed9\u540e\u7aef\u7684 RAG \u68c0\u7d22\u3001\u751f\u6210\u4e0e\u5206\u5757\u914d\u7f6e\uff0c\u4fbf\u4e8e\u8c03\u4f18\u548c\u9a8c\u6536\u57fa\u7ebf\u3002</div>
            <div class="chunk-meta">
                ...
                · query_prefix: ${State.tuning.role_query_prefix_enabled} · kb_user_boost: ${State.tuning.kb_user_name_boost}
                · kb_assistant_boost: ${State.tuning.kb_character_name_boost} · kb_source_boost: ${State.tuning.kb_source_name_boost}
        ...
        <div class="chunk-item">
            ...
            <div class="chunk-text">\u5206\u6790\u5f0f\u751f\u6210\u534f\u8bae\u4e0e\u6a21\u578b\u517c\u5bb9\u7b56\u7565\u3002</div>
            <div class="chunk-meta">
    ...
    DOM.tabStats.innerHTML = `
        ...
        <div class="chunk-item">
            <div class="chunk-header"><strong>\u65b9\u6848\u8bb0\u5f55</strong><span class="chunk-source">${Utils.escapeHtml(report.chat_stats?.status || "")}</span></div>
            <div class="chunk-meta">\u8bb0\u5f55 ${report.chat_stats?.total_sessions ?? 0} \u00b7 \u539f\u5b50\u5757 ${report.chat_stats?.total_atoms ?? 0}</div>
        </div>
    `;
}
...
async function loadArpmReport() {
    Utils.setDiagnoseStatus("\u8bfb\u53d6\u68c0\u7d22\u5e95\u5ea7\u62a5\u544a\u4e2d...", "processing");
    const report = await Utils.request("/api/diagnostics/arpm");
    renderArpmReport(report);
    Utils.setDiagnoseStatus("\u68c0\u7d22\u5e95\u5ea7\u62a5\u544a\u5df2\u52a0\u8f7d", "success");
}
...
function buildRagHelp() {
    DOM.ragHelpContent.innerHTML = `
        <div class="chunk-item">
            <div class="chunk-header"><strong>\u603b\u6d41\u7a0b</strong><span class="chunk-source">RAG</span></div>
            <div class="chunk-text">\u5f53\u524d\u524d\u7aef\u53ea\u5c55\u793a\u540e\u7aef\u771f\u5b9e\u5b58\u5728\u7684\u94fe\u8def\uff1a\u77e5\u8bc6\u5e93\u53ec\u56de\u3001\u5f53\u524d\u65b9\u6848\u8bb0\u5f55\u53ec\u56de\u3001\u5206\u522b\u52a0\u6743\u3001\u6700\u7ec8\u751f\u6210\uff0c\u4ee5\u53ca\u751f\u6210\u540e\u72ec\u7acb\u6267\u884c\u7684\u539f\u5b50\u5199\u5165\u3002</div>
        </div>
        <div class="chunk-item">
            <div class="chunk-header"><strong>\u77e5\u8bc6\u5e93\u53ec\u56de</strong><span class="chunk-source">Top-K</span></div>
            <div class="chunk-text">\u4ece\u5168\u5c40\u77e5\u8bc6\u5e93\u7d22\u5f15\u4e2d\u53ec\u56de\u76f8\u5173\u7236\u5757\u3002\u77e5\u8bc6\u5e93\u7ed3\u679c\u4f1a\u5355\u72ec\u8ba1\u7b97\u52a0\u6743\u4e0e\u53cc\u65f6\u6001\u6743\u91cd\uff0c\u4e0d\u548c\u65b9\u6848\u8bb0\u5f55\u5171\u7528\u4e00\u5957\u7ed3\u679c\u96c6\u3002</div>
        </div>
        <div class="chunk-item">
            <div class="chunk-header"><strong>\u65b9\u6848\u8bb0\u5f55\u53ec\u56de</strong><span class="chunk-source">Session</span></div>
            <div class="chunk-text">\u4ec5\u68c0\u7d22\u5f53\u524d\u65b9\u6848\u7684\u5386\u53f2\u539f\u5b50\u5757\uff0c\u4e0d\u4f1a\u6df7\u5165\u5176\u4ed6\u8bb0\u5f55\u3002\u65b9\u6848\u8bb0\u5f55\u7ed3\u679c\u4e5f\u4f1a\u72ec\u7acb\u8ba1\u7b97\u81ea\u5df1\u7684\u6743\u91cd\u3002</div>
        </div>
        <div class="chunk-item">
            <div class="chunk-header"><strong>\u53cc\u65f6\u6001\u6743\u91cd</strong><span class="chunk-source">Temporal</span></div>
            <div class="chunk-text">\u540e\u7aef\u4f1a\u5206\u522b\u5bf9\u77e5\u8bc6\u5e93\u7ed3\u679c\u548c\u65b9\u6848\u8bb0\u5f55\u7ed3\u679c\u65bd\u52a0\u8f6e\u6b21\u8870\u51cf\u4e0e\u7269\u7406\u65f6\u95f4\u8870\u51cf\uff0c\u524d\u7aef\u5c55\u793a\u7684\u662f\u5404\u81ea\u52a0\u6743\u540e\u7684\u7ed3\u679c\u3002</div>
        </div>
        <div class="chunk-item">
            <div class="chunk-header"><strong>\u539f\u5b50\u5199\u5165</strong><span class="chunk-source">Write Path</span></div>
            <div class="chunk-text">\u539f\u5b50\u5199\u5165\u53d1\u751f\u5728\u751f\u6210\u5b8c\u6210\u4e4b\u540e\uff0c\u53ea\u8d1f\u8d23\u628a\u5f53\u524d\u8f6e\u65b9\u6848\u8bb0\u5f55\u5199\u5165\u5f53\u524d\u7d22\u5f15\u3002\u5b83\u4e0d\u53c2\u4e0e\u77e5\u8bc6\u5e93\u6743\u91cd\u8ba1\u7b97\u3002</div>
        </div>
    `;
}
